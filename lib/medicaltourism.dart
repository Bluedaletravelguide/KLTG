...
class _MedicalTState extends State<MedicalT> {
  ...
  void initState() {
    ...
    _data2 = fetchData('appMedicalT_dtl', );
    _data3 = fetchData('appMedicalT_der', );
    _data4 = fetchData('appMedicalT_oph',);
  }
    ...
    return DefaultTabController(
      ...
      child: Scaffold(
        appBar: AppBar(
          ...
          title:
              const Text("Medical Tourism", style: TextStyle(color: Colors.white)),
