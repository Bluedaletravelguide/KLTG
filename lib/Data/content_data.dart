...
//Bar 12b
  ContentClass(
      ...
      decrepitation: '-',
      content:
          'Extremely fashionable Zeta Bar is a common late-night hangout and the spot to be seen and heard. It’s the only club in town with a live foreign band, it has a cool atmosphere that is ideal if you want fantastic music and a lively club scene.',
      workhour:
          '8pm - 2am (Mon - Tue)\n8pm - 3am (Wed, Thurs, Fri, Sat)\nClosed (Sun)',
      fees: '-',
      phoneNo: '-',
      locationText:
          'Level 5, 3, Jalan Stesen Sentral, Kuala Lumpur Sentral, 50470 Kuala Lumpur, Wilayah Persekutuan Kuala Lumpur, Malaysia.',
      locationUrl: 'https://goo.gl/maps/MLKXnt4hTPNyUiYL9',
      webText: 'Zeta bar Website',
      webUrl: 'https://www.eatdrinkhilton.com/zeta-bar/'),
  ContentClass(
      id: 'cl2_12b',
      decrepitation: '-',
      content:
          'PS150 is located in a pre-war shop lot on Petaling Street. The cocktail menu is categorised into five categories: retro, classic, tiki, disco and contemporary. For those who wish to enjoy the fresh air, the outdoor courtyard has an outdoor courtyard.\n\nDress Code:\nSun - Thurs: Anything you wish\nFriday & Saturday & Eve of Public Holidays: No flip-flops / slippers / sandals',
      workhour: '5pm - 12am (Daily)',
      fees: '-',
      phoneNo: '+603-76228777',
      locationText:
          'Ground Floor, 150, Jalan Petaling, City Centre, 50000 Kuala Lumpur, Wilayah Persekutuan Kuala Lumpur',
      locationUrl: 'https://g.page/PS150KL?share',
      webText: 'ps150.my',
      webUrl: 'http://www.ps150.my/ '),
  ContentClass(
      id: 'cl3_12b',
      decrepitation: '-',
      content:
          'The Iron Fairies in Kuala Lumpur is one of the most expensive bars in the city. Ashley Sutton, one of Asia\'s most well-known bar designers, created the space with the name deriving from an old book that the designer wrote about when he was 17 and worked in a mine. It portrays a world of fairies made of iron.',
      workhour: '5pm - 12am (Wed - Sun)',
      fees: '-',
      phoneNo: '016-2213612',
      locationText:
          'TREC Entry 3, H-G-06, 438 Jalan Tun Razak, 50400 Kuala Lumpur, Malaysia ',
      locationUrl: 'https://goo.gl/maps/79QxkGY3nn2rqa2Q6',
      webText: 'ironfarieskl.com',
      webUrl: 'https://ironfairieskl.com/index.html'),
  ContentClass(
      id: 'cl4_12b',
      decrepitation: '-',
      content:
          'Pahit is a gin-centric bar in Kuala Lumpur. Its atmosphere is simple - a rustic and relaxed 1920s shop lot - allowing its house infusions, traditional and contemporary gin-based cocktails to take centre stage.',
      workhour: '3pm - 12am (Tue - Sun), Closed (Mon)',
      fees: '-',
      phoneNo: '-',
      locationText:
          '3, Jalan Sin Chew Kee, Bukit Bintang, 50150 Kuala Lumpur, Wilayah Persekutuan Kuala Lumpur',
      locationUrl: 'https://goo.gl/maps/qmjXAqRsKii1dSja6',
      webText: 'Facebook Page',
      webUrl: 'https://www.facebook.com/barpahit/'),
  ContentClass(
      id: 'cl5_12b',
      decrepitation: '-',
      content:
          'Mantra is a lounge bar situated on a rooftop that overlooks the city skyline. The bar itself has a modern setting mixed together with a tropical touch. Herbs and spices are used to create a fusion of natural and western flavours.',
      workhour: '-',
      fees: '-',
      phoneNo: '-',
      locationText:
          'Bangsar Village II, Jalan Telawi Satu, Bangsar Baru, Kuala Lumpur, Malaysia 59100',
